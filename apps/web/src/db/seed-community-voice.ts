...
async function main() {
  ...
  console.log(`Created: ${corpus.name} (${corpus.id})`);

  // ─── Patrons ─────────────────────────────────────────────
  await db.insert(cppPatrons).values([
    { corpusId: corpus.id, walletAddress: "0x6fB8...a2C5", role: "Creator", pulseAmount: 240000, share: "0" },
    { corpusId: corpus.id, walletAddress: "0xX1y2...Z3a4", role: "Governor", pulseAmount: 120000, share: "0" },
    { corpusId: corpus.id, walletAddress: "0xB5c6...D7e8", role: "Investor", pulseAmount: 120000, share: "0" },
    { corpusId: corpus.id, walletAddress: "0xF9g0...H1i2", role: "Contributor", pulseAmount: 60000, share: "0" },
    { corpusId: corpus.id, walletAddress: "0xJ3k4...L5m6", role: "Advisor", pulseAmount: 60000, share: "0" },
  ]);
  ...
  await db.insert(cppRevenues).values([
    { corpusId: corpus.id, amount: "0.012", source: "product_review", currency: "USDC" },
    { corpusId: corpus.id, amount: "0.012", source: "product_review", currency: "USDC" },
    { corpusId: corpus.id, amount: "0.012", source: "product_review", currency: "USDC" },
  ]);
